...
const Slider = ({ passMovie }) => {
  ...
  useEffect(() => {
    axios
      .get(
        "https://api.themoviedb.org/3/movie/now_playing?api_key=3314664ffa608874a6c049e1f7faeb2c&language=en-US&page=1"
      )
      .then((res) => {
            ...
            {movies.map((value, index) => {
              return (
                <SliderCard
                  ...
                  setLoadFromChild={setLoadFromChild}
                ></SliderCard>
              );
            })}
